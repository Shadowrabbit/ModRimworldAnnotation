...
namespace RimWorld
{
    ...
    public class SitePartWorker
    {
        ...
        public virtual void Notify_GeneratedByQuestGen(SitePart part, Slate slate, List<Rule> outExtraDescriptionRules,
        ...
        public virtual string GetArrivedLetterPart(Map map, out LetterDef preferredLetterDef,
