...
namespace RimWorld
{
    ...
    public class CompProperties_Power : CompProperties
    {
        ...
        public override IEnumerable<StatDrawEntry> SpecialDisplayStats(StatRequest req)
        {
            ...
            {
                yield return new StatDrawEntry(StatCategoryDefOf.Building, "PowerConsumption".Translate(),
                    this.basePowerConsumption.ToString("F0") + " W", "Stat_Thing_PowerConsumption_Desc".Translate(), 5000, null, null,
                    false);
            }
            yield break;
            yield break;
