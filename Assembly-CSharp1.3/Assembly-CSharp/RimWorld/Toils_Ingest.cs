...
namespace RimWorld
{
	...
	{
		// Token: 0x06003414 RID: 13332 RVA: 0x001277E0 File Offset: 0x001259E0
		...
		// Token: 0x06003415 RID: 13333 RVA: 0x00127854 File Offset: 0x00125A54
		...
		// Token: 0x06003416 RID: 13334 RVA: 0x001278A4 File Offset: 0x00125AA4
		public static Toil CarryIngestibleToChewSpot(Pawn pawn, TargetIndex ingestibleInd)
		{
			Toils_Ingest.<>c__DisplayClass3_0 CS$<>8__locals1 = new Toils_Ingest.<>c__DisplayClass3_0();
			CS$<>8__locals1.ingestibleInd = ingestibleInd;
			CS$<>8__locals1.pawn = pawn;
			CS$<>8__locals1.toil = new Toil();
			CS$<>8__locals1.toil.initAction = delegate()
			{
				Toils_Ingest.<>c__DisplayClass3_1 CS$<>8__locals2 = new Toils_Ingest.<>c__DisplayClass3_1();
				CS$<>8__locals2.CS$<>8__locals1 = CS$<>8__locals1;
				CS$<>8__locals2.actor = CS$<>8__locals1.toil.actor;
				IntVec3 intVec = IntVec3.Invalid;
				Thing thing = null;
				Thing thing2 = CS$<>8__locals2.actor.CurJob.GetTarget(CS$<>8__locals1.ingestibleInd).Thing;
				CS$<>8__locals2.baseChairValidator = delegate(Thing t)
				{
					...
					IntVec3 intVec2;
					if (!base.<CarryIngestibleToChewSpot>g__TryFindFreeSittingSpotOnThing|1(t, out intVec2))
					{
						return false;
					}
					if (t.IsForbidden(CS$<>8__locals2.CS$<>8__locals1.pawn))
					{
						return false;
					}
					if (!CS$<>8__locals2.actor.CanReserve(t, 1, -1, null, false))
					{
						return false;
					}
					if (!t.IsSociallyProper(CS$<>8__locals2.actor))
					{
						return false;
					}
					if (t.IsBurning())
					...
					if (t.HostileTo(CS$<>8__locals2.CS$<>8__locals1.pawn))
					{
						return false;
					}
					bool result = false;
				...
				{
					thing = GenClosest.ClosestThingReachable(CS$<>8__locals2.actor.Position, CS$<>8__locals2.actor.Map, ThingRequest.ForGroup(ThingRequestGroup.BuildingArtificial), PathEndMode.OnCell, TraverseParms.For(CS$<>8__locals2.actor, Danger.Deadly, TraverseMode.ByPawn, false, false, false), thing2.def.ingestible.chairSearchRadius, (Thing t) => CS$<>8__locals2.baseChairValidator(t) && t.Position.GetDangerFor(CS$<>8__locals2.CS$<>8__locals1.pawn, t.Map) == Danger.None, null, 0, -1, false, RegionType.Set_Passable, false);
				}
				if (thing == null)
				{
					intVec = RCellFinder.SpotToChewStandingNear(CS$<>8__locals2.actor, CS$<>8__locals2.actor.CurJob.GetTarget(CS$<>8__locals1.ingestibleInd).Thing, (IntVec3 c) => CS$<>8__locals2.actor.CanReserveSittableOrSpot(c, false));
					Danger chewSpotDanger = intVec.GetDangerFor(CS$<>8__locals1.pawn, CS$<>8__locals2.actor.Map);
					if (chewSpotDanger != Danger.None)
					{
						thing = GenClosest.ClosestThingReachable(CS$<>8__locals2.actor.Position, CS$<>8__locals2.actor.Map, ThingRequest.ForGroup(ThingRequestGroup.BuildingArtificial), PathEndMode.OnCell, TraverseParms.For(CS$<>8__locals2.actor, Danger.Deadly, TraverseMode.ByPawn, false, false, false), thing2.def.ingestible.chairSearchRadius, (Thing t) => CS$<>8__locals2.baseChairValidator(t) && t.Position.GetDangerFor(CS$<>8__locals2.CS$<>8__locals1.pawn, t.Map) <= chewSpotDanger, null, 0, -1, false, RegionType.Set_Passable, false);
					}
				}
				if (thing != null && !CS$<>8__locals2.<CarryIngestibleToChewSpot>g__TryFindFreeSittingSpotOnThing|1(thing, out intVec))
				{
				...
				CS$<>8__locals2.actor.ReserveSittableOrSpot(intVec, CS$<>8__locals2.actor.CurJob, true);
				CS$<>8__locals2.actor.Map.pawnDestinationReservationManager.Reserve(CS$<>8__locals2.actor, CS$<>8__locals2.actor.CurJob, intVec);
				CS$<>8__locals2.actor.pather.StartPath(intVec, PathEndMode.OnCell);
			};
			CS$<>8__locals1.toil.defaultCompleteMode = ToilCompleteMode.PatherArrival;
			return CS$<>8__locals1.toil;
		}

		// Token: 0x06003417 RID: 13335 RVA: 0x001278FC File Offset: 0x00125AFC
		...
		// Token: 0x06003418 RID: 13336 RVA: 0x00127960 File Offset: 0x00125B60
		...
		// Token: 0x06003419 RID: 13337 RVA: 0x00127B14 File Offset: 0x00125D14
		...
		// Token: 0x0600341A RID: 13338 RVA: 0x00127B6C File Offset: 0x00125D6C
		...
		// Token: 0x0600341B RID: 13339 RVA: 0x00127C60 File Offset: 0x00125E60
		...
		// Token: 0x0600341C RID: 13340 RVA: 0x00127CE0 File Offset: 0x00125EE0
