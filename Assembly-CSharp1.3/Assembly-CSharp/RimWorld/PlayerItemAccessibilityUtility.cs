...
namespace RimWorld
{
	...
	{
		// Token: 0x06007DEB RID: 32235 RVA: 0x002C9B4C File Offset: 0x002C7D4C
		...
		// Token: 0x06007DEC RID: 32236 RVA: 0x002C9BA8 File Offset: 0x002C7DA8
		...
		// Token: 0x06007DED RID: 32237 RVA: 0x002C9C16 File Offset: 0x002C7E16
		...
		// Token: 0x06007DEE RID: 32238 RVA: 0x002C9C30 File Offset: 0x002C7E30
			...
			if (num7 > 0)
			{
				...
				for (int num9 = 0; num9 < PlayerItemAccessibilityUtility.cachedAccessibleThings.Count; num9++)
				{
					...
					if (building_WorkTable != null && building_WorkTable.Spawned && PlayerItemAccessibilityUtility.tmpWorkTables.Add(building_WorkTable.def))
					{
						...
						{
							if (allRecipes[num10].AvailableNow && allRecipes[num10].AvailableOnNow(building_WorkTable, null) && allRecipes[num10].products.Any<ThingDefCountClass>() && !allRecipes[num10].PotentiallyMissingIngredients(null, building_WorkTable.Map).Any<ThingDef>())
							{
		...
		// Token: 0x06007DEF RID: 32239 RVA: 0x002CA3D4 File Offset: 0x002C85D4
		...
		// Token: 0x06007DF0 RID: 32240 RVA: 0x002CA588 File Offset: 0x002C8788
		...
		// Token: 0x06007DF1 RID: 32241 RVA: 0x002CA7A0 File Offset: 0x002C89A0
