...
namespace Verse
{
	...
	{
		// Token: 0x06001B8B RID: 7051 RVA: 0x000A06A4 File Offset: 0x0009E8A4
		...
		// Token: 0x06001B8C RID: 7052 RVA: 0x000A06AD File Offset: 0x0009E8AD
		...
		// Token: 0x06001B8D RID: 7053 RVA: 0x000A06B7 File Offset: 0x0009E8B7
		...
		// Token: 0x06001B8E RID: 7054 RVA: 0x000A06C4 File Offset: 0x0009E8C4
		...
		// Token: 0x06001B8F RID: 7055 RVA: 0x000A0798 File Offset: 0x0009E998
		private static void GenerateQuests(int count, bool logDescOnly)
		{
			...
			CS$<>8__locals1.selectPopulation = delegate(QuestScriptDef script, Slate slate, Action next)
			{
				List<DebugMenuOption> list2 = new List<DebugMenuOption>();
			...
			list.Add(new DebugMenuOption("*Natural random", DebugMenuOptionMode.Action, delegate()
			{
				...
				CS$<>8__locals1.selectPoints(null, slate, delegate
				{
					...
					{
						CS$<>8__locals1.selectPopulation(script, slate, delegate
						{
				...
				while (enumerator.MoveNext())
				{
					...
					list.Add(new DebugMenuOption(defName, DebugMenuOptionMode.Action, delegate()
					{
						...
						if (localScriptDef.affectedByPoints && localScriptDef.affectedByPopulation)
						{
							...
							{
								Action<QuestScriptDef, Slate, Action> selectPopulation = CS$<>8__locals2.CS$<>8__locals5.selectPopulation;
								QuestScriptDef localScriptDef = localScriptDef;
								Slate slate = slate;
								Action arg;
								if ((arg = <>9__14) == null)
								{
								...
								selectPopulation(localScriptDef, slate, arg);
							});
							return;
						}
						...
						{
							CS$<>8__locals2.CS$<>8__locals5.selectPopulation(localScriptDef, slate, delegate
							{
								CS$<>8__locals2.CS$<>8__locals5.generateQuest(localScriptDef, slate);
							});
							return;
		...
		// Token: 0x06001B90 RID: 7056 RVA: 0x000A0928 File Offset: 0x0009EB28
		...
		// Token: 0x06001B91 RID: 7057 RVA: 0x000A09C4 File Offset: 0x0009EBC4
		...
		// Token: 0x06001B92 RID: 7058 RVA: 0x000A0A50 File Offset: 0x0009EC50
		[DebugOutput]
		...
		// Token: 0x06001B93 RID: 7059 RVA: 0x000A0B14 File Offset: 0x0009ED14
		[DebugOutput]
		...
		// Token: 0x06001B94 RID: 7060 RVA: 0x000A0DF0 File Offset: 0x0009EFF0
		[DebugOutput]
		...
		// Token: 0x06001B95 RID: 7061 RVA: 0x000A0EAC File Offset: 0x0009F0AC
		[DebugOutput]
