...
namespace Verse.AI
{
	...
	{
		// Token: 0x06002A20 RID: 10784 RVA: 0x000FDDCC File Offset: 0x000FBFCC
		...
		// Token: 0x06002A21 RID: 10785 RVA: 0x000FDEC4 File Offset: 0x000FC0C4
		...
		// Token: 0x06002A22 RID: 10786 RVA: 0x000FDF1C File Offset: 0x000FC11C
		...
		// Token: 0x06002A23 RID: 10787 RVA: 0x000FDF68 File Offset: 0x000FC168
		public static Toil CheckForGetOpportunityDuplicate(Toil getHaulTargetToil, TargetIndex haulableInd, TargetIndex storeCellInd, bool takeFromValidStorage = false, Predicate<Thing> extraValidator = null)
		{
			...
			toil.initAction = delegate()
			{
				...
				Thing thing = GenClosest.ClosestThingReachable(actor.Position, actor.Map, ThingRequest.ForGroup(ThingRequestGroup.HaulableAlways), PathEndMode.ClosestTouch, TraverseParms.For(actor, Danger.Deadly, TraverseMode.ByPawn, false, false, false), 8f, validator, null, 0, -1, false, RegionType.Set_Passable, false);
				if (thing != null)
				{
		...
		// Token: 0x06002A24 RID: 10788 RVA: 0x000FDFC8 File Offset: 0x000FC1C8
		...
		// Token: 0x06002A25 RID: 10789 RVA: 0x000FE034 File Offset: 0x000FC234
		...
		// Token: 0x06002A26 RID: 10790 RVA: 0x000FE078 File Offset: 0x000FC278
		...
		// Token: 0x06002A27 RID: 10791 RVA: 0x000FE0D0 File Offset: 0x000FC2D0
		...
		// Token: 0x06002A28 RID: 10792 RVA: 0x000FE130 File Offset: 0x000FC330
			...
			toil.initAction = delegate()
			{
				...
				if (thingOwner != null)
				{
					...
					if (actor.carryTracker.innerContainer.TryTransferToContainer(actor.carryTracker.CarriedThing, thingOwner, num, true) != 0)
					{
						...
						Action onDeposited2 = onDeposited;
						if (onDeposited2 == null)
						{
							return;
						}
						onDeposited2();
		...
		// Token: 0x06002A29 RID: 10793 RVA: 0x000FE180 File Offset: 0x000FC380
		public static Toil JumpToCarryToNextContainerIfPossible(Toil carryToContainerToil, TargetIndex primaryTargetInd)
		{
			...
			toil.initAction = delegate()
			{
				...
				if (curJob.targetQueueB != null && curJob.targetQueueB.Count > 0)
				{
					...
					select targ.Thing, PathEndMode.Touch, TraverseParms.For(actor, Danger.Deadly, TraverseMode.ByPawn, false, false, false), 99999f, validator, null);
					if (nextTarget != null)
					{
		...
		// Token: 0x06002A2A RID: 10794 RVA: 0x000FE1CC File Offset: 0x000FC3CC
		public static Toil TakeToInventory(TargetIndex ind, int count)
		{
			return Toils_Haul.TakeToInventory(ind, () => count);
		}

		// Token: 0x06002A2B RID: 10795 RVA: 0x000FE1F8 File Offset: 0x000FC3F8
