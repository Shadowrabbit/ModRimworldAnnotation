...
namespace Verse
{
    ...
    public static class GenClosest
    {
        ...
        private static bool EarlyOutSearch(IntVec3 start, Map map, ThingRequest thingReq,
            IEnumerable<Thing> customGlobalSearchSet, Predicate<Thing> validator)
        {
            ...
            return thingReq.group == ThingRequestGroup.Nothing ||
                   ((thingReq.IsUndefined || map.listerThings.ThingsMatching(thingReq).Count == 0) &&
                    customGlobalSearchSet.EnumerableNullOrEmpty<Thing>());
        }
            ...
            bool ignoreEntirelyForbiddenRegions = false)
        {
            ...
            if (!thingReq.IsUndefined && thingReq.CanBeFoundInRegion)
            {
                ...
                thing = GenClosest.RegionwiseBFSWorker(root, map, thingReq, peMode, traverseParams, validator, null,
                    searchRegionsMin, num, maxDistance, out num2, traversableRegionTypes,
            ...
            if (thing == null && flag && !flag2)
            {
                ...
                Predicate<Thing> validator2 = (Thing t) =>
                    map.reachability.CanReach(root, t, peMode, traverseParams) && (validator == null || validator(t));
        ...
        public static Thing ClosestThing_Regionwise_ReachablePrioritized(IntVec3 root, Map map, ThingRequest thingReq,
            ...
            Predicate<Thing> validator = null, Func<Thing, float> priorityGetter = null, int minRegions = 24,
            int maxRegions = 30)
        {
            if (!thingReq.IsUndefined && !thingReq.CanBeFoundInRegion)
            {
            ...
            {
                int num;
                result = GenClosest.RegionwiseBFSWorker(root, map, thingReq, peMode, traverseParams, validator,
                    priorityGetter, minRegions, maxRegions, maxDistance, out num, RegionType.Set_Passable, false);
            }
        ...
        public static Thing RegionwiseBFSWorker(IntVec3 root, Map map, ThingRequest req, PathEndMode peMode,
            ...
            int maxRegions, float maxDistance, out int regionsSeen,
            RegionType traversableRegionTypes = RegionType.Set_Passable, bool ignoreEntirelyForbiddenRegions = false)
        {
            ...
            RegionEntryPredicate entryCondition = (Region from, Region to) => to.Allows(traverseParams, false) &&
                                                                              (maxDistance > 5000f ||
        ...
        public static Thing ClosestThing_Global(IntVec3 center, IEnumerable searchSet, float maxDistance = 99999f,
            Predicate<Thing> validator = null, Func<Thing, float> priorityGetter = null)
        {
        ...
        [CompilerGenerated]
        internal static void <ClosestThing_Global>g__Process|5_0(Thing t, ref
        GenClosest.<>c__DisplayClass5_0 A_1)
        {
            if (!t.Spawned)
            {
                return;
        ...
        [CompilerGenerated]
        internal static void <ClosestThing_Global_Reachable>g__Process|6_0(Thing t, ref
        GenClosest.<>c__DisplayClass6_0 A_1)
        {
            if (!t.Spawned)
            {
                return;
